<%@ page contentType="text/html; charset=UTF-8" %>
 ...
 function guest_delete() {
   var urlString;
    urlString = "guest_delete?idx=${guest.idx}&page=${page}";
    window.open(urlString, "guest_delete"," resizable=no,x=150,y=150,width=300,height=170");
 }
   ...
   <table border="0" width="800">
     <tr>
      ...
      <font size="2">
       ...
       <a href="guest_write?page=${page}"><img src="Guest/img/write.jpg" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;
      </font>
    </td>
  </tr>
  </table>
