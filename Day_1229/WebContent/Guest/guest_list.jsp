...
<%@ page import = "java.util.*,Day_1229.model.*"%>
<%
  ...
  <tr>
    ...
    <table border="0" cellspacing="1" width="100%" align="center">
      ...
      <tr>
		...
		<font size="2" face="고딕">전체 : ${totcount}</b>건 - ${totpage} / ${page} Pages</font></td></tr>
 	   <tr bgcolor="e3e9ff">
...
%>
        ...
        <font face="돋움" size="2" color="#000000">
		      <a href="guest_view?idx=<%=list.get(i).getIdx()%>&page=${page}"><%=list.get(i).getSubject() %></a></td>
     ...
     <div align="center">
		...
		<tr>
			...
			<td width="50%" align="center">
				<table>
					<form name="search" method="post" action="guest_list">	
